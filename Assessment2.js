...
function getNewQuestion(){
    ...
    const index1=availableQuestions.indexOf(questionIndex);//learn what is the function of it.
    availableQuestions.splice(index1,1)//learn what is the function of it.
